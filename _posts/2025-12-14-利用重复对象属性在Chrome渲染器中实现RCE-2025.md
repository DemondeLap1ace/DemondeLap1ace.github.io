...
https://nvd.nist.gov/vuln/detail/cve-2024-3383
...
- structuredClone(): 红队重点关注。这是一个深拷贝函数，涉及复杂的序列化和反序列化逻辑，极易在处理特殊对象（如 SharedArrayBuffer, WASM Modules, Errors）时出现状态不同步。
